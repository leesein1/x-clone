...
import { ActionIcon, Actions, ButtonRow, ContentColumn, DateText, DeleteButton, Dot, EditButton, Handle, Header, IconButton, Payload, ProfileColumn, ProfileImage, TweetImage, Username, Wrapper } from "./design/tweet-design";


export default function Tweet({ username, photo, tweet, userId, id, userPhotoURL, createdAt, createdAtString, userHandle}: ITweet) {
